"""
Django settings for HappyPatent project.
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'happypatent.contrib.sites.migrations'
}
...
ADMINS = [
    ("""Kuanting Shen""", 'bruce20036@gmail.com'),
]
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///happypatent'),
}
...
SOCIALACCOUNT_ADAPTER = 'happypatent.users.adapters.SocialAccountAdapter'
...
CKEDITOR_CONFIGS = {
    'default': {
        ...
        'toolbar_Custom': [
            ...
            ['TextColor', 'BGColor', 'RemoveFormat', 'Font', 'FontSize'],
