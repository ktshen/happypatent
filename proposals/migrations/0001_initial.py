    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('application_type', models.CharField(blank=True, choices=[('invention', 'Invention'), ('utility', 'Utility'), ('design', 'Design'), ('trademark', 'Trademark')], max_length=30, verbose_name='Type')),
                ...
                ('case_status', models.CharField(blank=True, choices=[('1', 'Draft/Translation'), ('2', 'Preliminary examination'), ('3', 'Response/Amendment-1'), ('4', 'Response/amendment-2'), ('5', 'Rejection'), ('6', 'Publication'), ('7', 'Re-examination'), ('8', 'Appeal'), ('9', 'Re-appeal'), ('10', 'Administrative litigation'), ('11', 'Paying issue fee'), ('12', 'Allowed'), ('13', 'Abandoned'), ('14', 'Invalidation examination')], max_length=30, verbose_name='Status')),
                ...
                ('IDS_information', models.TextField(blank=True, verbose_name='IDS Information')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='Created Time')),
                ('update', models.DateTimeField(auto_now=True, null=True, verbose_name='Latest Update')),
                ('proposal_id', models.CharField(blank=True, max_length=50, verbose_name='Proposal ID')),
                ...
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='Created by')),
                ('inventors', models.ManyToManyField(to='proposals.Inventor', verbose_name='Inventor')),
            ],
            options={
                'abstract': False,
            },
