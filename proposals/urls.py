...
urlpatterns = [
    ...
    url(r'^(?P<case_id>[-\w]+)/update/$', views.PatentUpdateView.as_view(),
        name='patent-update'),
    url(r'^patent/search/$', views.PatentSearchView.as_view(), name='patent-search'),
    ...
    url(r'^contact_person/(?P<pk>\d+)/update/$', views.ContactPersonDetailView.as_view(), name='contact_person-udpate'),
